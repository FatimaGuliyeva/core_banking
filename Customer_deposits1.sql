...
begin
 ...
 (p_id number,p_customer_id number, p_deposit_product_id number, p_contract_no varchar2, p_deposit_amount number ,p_profit_amount number, p_start_date date) is
 begin
 update cb_customer_deposits set customer_id=nvl(p_customer_id, customer_id),
