...
begin
 ...
 (p_id number, p_currency_id number, p_product_name varchar2 default null, p_term number default null,p_interest_rate number default null) is
 begin
 update CB_DEPOSIT_PRODUCTS set currency_id=nvl(p_currency_id, currency_id),
